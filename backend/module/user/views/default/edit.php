                        ...
                        <div class="ibox-content">
                            <form id="saveForm" action="post">
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">注册域名</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="register_domain"
                                               value="<?php echo $data['register_domain']; ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group row"><label class="col-sm-2 col-form-label">上级代理</label>
                                    <div class="col-sm-10">
                                        <select class="form-control m-b" name="agent_id">
                                            <option value="0"
                                                <?php if($data['agent_id'] == '0') { echo ' selected="selected"';} ?>>暂无</option>
                                            <option value="1"
                                                <?php if($data['agent_id'] == '1') { echo ' selected="selected"';} ?>>正常</option>
                                            <option value="2"
                                                <?php if($data['agent_id'] == '2') { echo ' selected="selected"';} ?>>禁用</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
...
<script>
    ...
    $(function(){
        $("#btn_save").click(function(){
            ...
            $.ajax({
                url:"<?php echo Url::toRoute(['/user/default/edit']); ?>",
                type:"post",
