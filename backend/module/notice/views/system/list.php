            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" style="top:10px">
                        <?php
                        if($this->params['position_id'] == 1 || in_array(6,$this->params['power_id'])) {
                            ?>
                            <a class="btn btn-primary btn-sm" href="<?php echo Url::toRoute(['/notice/system/create']); ?>">新增消息</a>
                            <?php
                        }
                        ?>
                    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            if (isset($list) && $list) {
                                foreach ($list as $k => $v) {
                                    ...
                                    <?php
                                    if($this->params['position_id'] == 1 || in_array(7,$this->params['power_id'])) {
                                        ?>
                                    ...
                                    ?>
                                            ...
                                            <?php
                                            if($this->params['position_id'] == 1 || in_array(8,$this->params['power_id'])) {
                                            ?>
                                            <?php
                                            if ($v['status'] == 1) {
                                                ?>
...
<script>
    ...
    {
        $.ajax({
            url:"<?php echo Url::toRoute(['/notice/system/change-status']); ?>",
            type:"post",
            data:{
                id:id,
                status:status
